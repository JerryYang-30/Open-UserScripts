...
**简体中文** | [English](https://github.com/JerryYang-30/Open-UserScripts/blob/main/YouTube-Watch-Later-Redirect/README_en.md)
...
3. 或 [→点击此处←](https://github.com/JerryYang-30/Open-UserScripts/raw/main/YouTube-Watch-Later-Redirect/YouTube-Watch-Later-Redirect.user.js) 立刻安装（利用GreasyFork源更新）。
...
请看[CHANGELOG](https://github.com/JerryYang-30/Open-UserScripts/blob/main/YouTube-Watch-Later-Redirect/CHANGELOG.md)
